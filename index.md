...
permalink: /
notification: In line with Singapore's elevated set of safe distancing measures from 7 Apr (Tue) to 1 Jun 2020 (Mon), please be assured that Singapore Customs remains in operation. Businesses can continue to submit trade declarations via TradeNet and other requests via our eServices (www.customs.gov.sg/services) or the Networked Trade Platform (www.ntp.gov.sg).<br/> For payment of taxes at the various Checkpoints, please make an advance declaration using Customs@SG app or the web portal (www.go.gov.sg/customs-sg).
sections:
    - hero:
        title:
        subtitle:
        ...
        key_highlights:
            ...
            - title: Customs Schemes & Licenses
              url: /businesses/customs-schemes-licences-framework/trade-first
