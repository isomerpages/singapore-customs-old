...
Accordian:
  - Title: Frequently Asked Questions (FAQs)
    Content: ### A. Customs@SG Mobile App/Web Application
***
**1.** **What is this Customs@SG Mobile App about?**

Customs@SG is a mobile app developed by Singapore Customs to provide travellers and members of the public with a more convenient way to interact with us. The app has three modules: (a) Goods to Declare module; (2) Tip-off module; and (3) Feedback module.  
...
***
  - Title: Terms & Conditions
    Content: The terms and conditions for use of the **Customs@SG** /web application for declaration and payment of duty and/or Goods and Services Tax (GST) are as follows:
